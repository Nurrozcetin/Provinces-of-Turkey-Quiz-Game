...
public class timedGame extends AppCompatActivity {
    private TextView txtCityInfo, txtCityLetters, txtSumPoint, txtTime;
    private Button btnGetLetter, btnGuess, btnPlayAgain;
    ...
    private int randCityNumber, randLetterNumber, beginLetterNumber, totalTime = 180000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtCityInfo = (TextView) findViewById(R.id.txtTInfo);
        txtCityLetters = (TextView) findViewById(R.id.txtTSpace);
        txtSumPoint = (TextView)findViewById(R.id.txtTSumPoint);
        editTxtGuess = (EditText)findViewById(R.id.editTxtTGuess);
        btnGuess = (Button) findViewById(R.id.btnTGuess);
        btnGetLetter = (Button) findViewById(R.id.btnTGetLetter);
        ...
        new CountDownTimer(totalTime, 1000){
            ...
            public void onTick(long l) {
                txtTime.setText((l/60000) +":"+((l%60000) / 1000) );
            }
            ...
            public void onFinish() {
                ...
                btnGetLetter.setEnabled(false);
                editTxtGuess.setEnabled(false);
                btnPlayAgain.setVisibility(View.VISIBLE);

                Toast.makeText(getApplicationContext(), "Game is over!!\n Total Game Score: \n Please press the PLAY AGAIN button for play again "+ remainingPoint, Toast.LENGTH_LONG).show();
            }
        }.start();
    ...
    public void btnTimedGuess(View v) {
    ...
    public void btnTimedGetLetter(View v){
    ...
    public void btnPlayAgain(View v) {
        Intent playAgain = new Intent(this, timedGame.class);
        finish();
